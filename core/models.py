...
class Vendor(models.Model):
    ...
    address = models.CharField(max_length=100, default="Rua do Vendedor, 100")
    contact = models.CharField(max_length=100, default="+55 11 99999-9999")
...
class Product (models.Model):
    ...
    price = models.DecimalField(max_digits=999999999999, decimal_places=2, default=100.99)
