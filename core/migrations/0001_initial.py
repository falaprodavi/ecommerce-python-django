    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=100.99, max_digits=999999999999)),
                ('old_price', models.DecimalField(decimal_places=2, default=200.99, max_digits=999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Nestufy', max_length=100)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, null=True)),
                ('address', models.CharField(default='Rua do Vendedor, 100', max_length=100)),
                ('contact', models.CharField(default='+55 11 99999-9999', max_length=100)),
